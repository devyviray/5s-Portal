    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap" v-if="hasPagination">
        ...
        <nav v-if="!limitOnly">
            <ul class="pagination justify-content-center mb-0">
                <li class="page-item" @click="goToPage(pagination.first_page_url)"><a class="page-link"><i class="fas fa-angle-double-left"></i></a></li>
                <li class="page-item" @click="goToPage(pagination.prev_page_url)"><a class="page-link"><i class="fas fa-angle-left"></i></a></li>
                ...
                <li class="page-item" @click="goToPage(pagination.next_page_url)"><a class="page-link"><i class="fas fa-angle-right"></i></a></li>
                <li class="page-item" @click="goToPage(pagination.last_page_url)"><a class="page-link"><i class="fas fa-angle-double-right"></i></a></li>
            </ul>
        </nav>
    </div>
</template>

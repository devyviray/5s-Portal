                ...
                <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                        <tr v-for="(companyArea, c) in filteredQueues" v-bind:key="c">
                            ...
                            <td>{{ companyArea.operation_line.name }}</td>
                            <td>{{ companyArea.category.name }}</td>
                            <td>{{ companyArea.area.name }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <span class="text-danger" v-if="errors.company">{{ errors.name[0] }}</span>
                                </div>
                            </div>  
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" v-model="company_area.category">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="role">Category*</label>
                                    <select class="form-control" v-model="company_area_copied.category_id">
                                        <option v-for="(category,c) in categories" v-bind:key="c" :value="category.id"> {{ category.name }}</option>
                                    </select>
                                    <span class="text-danger" v-if="errors.category">{{ errors.category[0] }}</span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="role">Areas*</label> 
                                    <multiselect
                                        v-model="company_area_copied.area"
                                        :options="areas"
                                        :multiple="true"
                                        track-by="id"
                                        :custom-label="customLabel"

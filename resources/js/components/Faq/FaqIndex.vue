    ...
    <div id="wrapper">
        ...
        <div class="modal fade" id="exportModal" tabindex="-1" role="dialog" data-backdrop="static">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addCompanyLabel">Export FAQ</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                   <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                Export this table as excel file?
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" data-dismiss='modal'>Close</button>
					<a class="btn btn-success" href="/faqs-export" @click="exportSuccess">Export</a>
                </div>
                </div>
            </div>
        </div>
